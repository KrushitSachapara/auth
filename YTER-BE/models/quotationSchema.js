...
const quotationSchema = new mongoose.Schema(
    {
        quotationNo: { type: String, trim: true, default: null },
        customerId: { type: mongoose.Schema.Types.ObjectId, ref: 'customer', default: null },
        broker: { type: mongoose.Schema.Types.ObjectId, ref: 'customer', default: null },
        generalNo: { type: mongoose.Schema.Types.ObjectId, ref: 'generalBook', default: null },
        username: { type: String, trim: true, default: '' },
        quotationDate: { type: String, trim: true, default: '' },
        items: [itemSchema],
