...
router.get('/options', (req, res) => {
    return customCategoryController.customCategory.getcustomCategoryOptions(req, res);
});

router.get('/get/formula', (req, res) => {
    return customCategoryController.customCategory.getFormulaByCustomCategory(req, res);
});
