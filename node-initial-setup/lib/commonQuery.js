...
commonQuery.findoneWithPopulate = function findoneWithPopulate(model, cond, populate, populate1, populate2) {
  return new Promise(function (resolve, reject) {
    model
      .findOne(cond)
      .populate(populate)
...
commonQuery.findLastOrFirstByValue = function findLastOrFirstByValue(model, field_name, sortType) {
  return new Promise(function (resolve, reject) {
    let to_sort = {};
...
commonQuery.uniqueInsertIntoCollection = function uniqueInsertIntoCollection(model, cond, obj) {
  return new Promise(function (resolve, reject) {
